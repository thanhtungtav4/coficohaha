    ...
    <section class="container">
        ...
        <?php if(ICL_LANGUAGE_CODE=='en'): ?>
            <ul class="nav nav-pills" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="https://www.stagging.cofico.com.vn/en/du-an/khu-phuc-hop/">Office & Complex Projects</a>
                </li>
                <li class="nav-item">
        ...
        <?php elseif(ICL_LANGUAGE_CODE=='vi'): ?>
            <ul class="nav nav-pills" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="https://www.stagging.cofico.com.vn/du-an/khu-phuc-hop/">Văn phòng & Khu phức hợp</a>
                </li>
                <li class="nav-item">
