            ...
            <section class="du_an">
                <div class="container">
                    ...
                    <div class="row duan_col">
                        ...
                        <div class="col-sm-6 duan_dis">
                            <div class="col text_duan">
                                <h4><a href="<?php echo get_option('siteurl') ?>en/go-supermarket-groundbreaking-ceremon">GO! Supermarket</a></h4>
                                <p><span>Project:</span>GO! Supermarket</p>
                                <p><span>Location:</span>Quang Ninh Province</p>
                                <div class="gap" style="line-height: 50px; height: 50px;"></div>
                                <a href="<?php echo get_option('siteurl') ?>en/go-supermarket-groundbreaking-ceremon" class="more_duan">+ Read more...</a>
                            </div>
                        ...
                        <div class="col-sm-6 duan_dis">
                            <div class="col text_duan">
                                ...
                                <p><span>Location:</span>istrict 2, Ho Chi Minh </p>
                                <div class="gap" style="line-height: 50px; height: 50px;"></div>
                    ...
                    <div class="owl-one owl-carousel css owl-theme">
                        <div class="item1">
                            <div class="col duan_dis">
                                <div class="col">
                                    <h5><a href="<?php echo get_option('siteurl') ?>/en/project/vista-verde-residental/">VISTA VERDE RESIDENTIAL</a></h5>
                                    <p><strong>Project:</strong>VISTA VERDE RESIDENTIAL</p>
                                    <p><strong>Address::</strong> Dist.2, HCMC</p>
                                    <a href="<?php echo get_option('siteurl') ?>/en/project/vista-verde-residental/" class="more_duan">+ Read more…</a>
                                </div>
                        ...
                        <div class="item1">
                            <div class="col duan_dis">
                                <div class="col">
                                    <h5><a href="<?php echo get_option('siteurl') ?>/en/project/du-an-estella-heights-2/">ESTELLA HEIGHTS 2</a></h5>
                                    <p><strong>Project:</strong>ESTELLA HEIGHTS 2</p>
                                    <p><strong>Address:</strong> Dist.2, HCMC</p>
                                    <a href="<?php echo get_option('siteurl') ?>/en/project/du-an-estella-heights-2/" class="more_duan">+ Read more…</a>
                                </div>
                                <div class="col card-img" style="background-image: url(<?php echo get_option('siteurl') ?>/wp-content/uploads/2014/10/vistaverde-thumbnail1.jpg);background-position: center;background-size: 100%;background-repeat: no-repeat;">
                        ...
                        <div class="item1">
                            <div class="col duan_dis">
                                <div class="col">
                                    <h5><a href="<?php echo get_option('siteurl') ?>/en/project/hausneo-apartment/">HAUSNEO APARTMENT</a></h5>
                                    <p><strong>Project:</strong> Hausneo Apartment</p>
                                    <p><strong>Address:</strong> Dist.9, HCMC</p>
                                    <a href="<?php echo get_option('siteurl') ?>/en/project/hausneo-apartment/" class="more_duan">+ Read more…</a>
                                </div>
                                <div class="col card-img" style="background-image: url(<?php echo get_option('siteurl') ?>/wp-content/uploads/2014/10/vistaverde-thumbnail1.jpg);background-position: center;background-size: 100%;background-repeat: no-repeat;">
                        ...
                        <div class="item1">
                            <div class="col duan_dis">
                                <div class="col">
                                    <h5><a href="<?php echo get_option('siteurl') ?>/project/du-an-can-ho-hausneo/">GATEWAY THAO DIEN</a></h5>
                                    <p><strong>Project:</strong> GATEWAY THAO DIEN</p>
                                    <p><strong>Address:</strong> Dist.2., HCMC</p>
                                    <a href="<?php echo get_option('siteurl') ?>/project/du-an-can-ho-hausneo/" class="more_duan">+ Read more…</a>
                                </div>
            ...
            <section class="du_an">
                <div class="container">
                    ...
                    <div class="row duan_col">
                        ...
                        <div class="col-sm-6 duan_dis">
                            <div class="col text_duan">
                                <h4><a href="<?php echo get_option('siteurl') ?>/le-dong-tho-sieu-thi-go-quang-ngai/">SIÊU THỊ GO!</a></h4>
                                <p><span>Dự Án:</span>SIÊU THỊ GO! QUẢNG NGÃI</p>
                                <p><span>Địa điểm:</span>Quảng Ngãi</p>
                                <div class="gap" style="line-height: 50px; height: 50px;"></div>
                                <a href="<?php echo get_option('siteurl') ?>/le-dong-tho-sieu-thi-go-quang-ngai/" class="more_duan">+ Xem Thêm...</a>
                            </div>
                            <div class="col img_duan2">
                                <img src="<?php echo get_option('siteurl') ?>/wp-content/uploads/2019/08/56157726_1174695192689777_8907272635826569216_o.jpg" width="245" height="248">
                            </div>
