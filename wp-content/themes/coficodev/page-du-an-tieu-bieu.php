    ...
    <section class="container">
        ...
        <?php if(ICL_LANGUAGE_CODE=='en'): ?>
            <ul class="nav nav-pills" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" href="https://www.cofico.com.vn/du-an/du-an-tieu-bieu/">View all</a>
                </li>
                <li class="nav-item">
        ...
        <?php elseif(ICL_LANGUAGE_CODE=='vi'): ?>
            <ul class="nav nav-pills" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" href="https://www.cofico.com.vn/du-an/du-an-tieu-bieu/">Tiêu Biểu</a>
                </li>
                <li class="nav-item">
