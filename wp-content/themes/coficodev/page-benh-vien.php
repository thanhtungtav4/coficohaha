    ...
    <section class="container">
        ...
        <?php if(ICL_LANGUAGE_CODE=='en'): ?>
            <ul class="nav nav-pills" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="https://www.stagging.cofico.com.vn/en/du-an/benh-vien/">Hospitals & Schools</a>
                </li>
                <li class="nav-item">
        ...
        <?php elseif(ICL_LANGUAGE_CODE=='vi'): ?>
            <ul class="nav nav-pills" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="https://www.stagging.cofico.com.vn/du-an/benh-vien/">Bệnh viện & Trường học</a>
                </li>
                <li class="nav-item">
