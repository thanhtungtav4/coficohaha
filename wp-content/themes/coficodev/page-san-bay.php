    ...
    <section class="container">
        ...
        <?php if(ICL_LANGUAGE_CODE=='en'): ?>
            <ul class="nav nav-pills" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link  active" href="https://www.stagging.cofico.com.vn/en/du-an/san-bay/">Airports & Bridges</a>
                </li>
            </ul>
        <?php elseif(ICL_LANGUAGE_CODE=='vi'): ?>
            <ul class="nav nav-pills" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link  active" href="https://www.stagging.cofico.com.vn/du-an/san-bay/">Sân bay & Cầu cảng</a>
                </li>
            </ul>
